...
const seedPublicData = (): void => {
    const rows = [
        [2023, "黑龙江", "哈尔滨工业大学", "计算机科学与技术", "物理+化学", 632],
        [2024, "黑龙江", "哈尔滨工业大学", "计算机科学与技术", "物理+化学", 640],
        [2025, "黑龙江", "哈尔滨工业大学", "计算机科学与技术", "物理+化学", 646],
        [2023, "黑龙江", "哈尔滨工业大学", "自动化", "物理+化学", 625],
        [2024, "黑龙江", "哈尔滨工业大学", "自动化", "物理+化学", 633],
        [2025, "黑龙江", "哈尔滨工业大学", "自动化", "物理+化学", 639],
        [2023, "黑龙江", "北京师范大学", "教育技术学", "物理不限", 618],
        [2024, "黑龙江", "北京师范大学", "教育技术学", "物理不限", 625],
        [2025, "黑龙江", "北京师范大学", "教育技术学", "物理不限", 632],
        [2023, "黑龙江", "东北师范大学", "思想政治教育", "政治", 592],
        [2024, "黑龙江", "东北师范大学", "思想政治教育", "政治", 598],
        [2025, "黑龙江", "东北师范大学", "思想政治教育", "政治", 604],
        [2023, "黑龙江", "东北林业大学", "林学", "物理或生物", 551],
        [2024, "黑龙江", "东北林业大学", "林学", "物理或生物", 558],
        [2025, "黑龙江", "东北林业大学", "林学", "物理或生物", 565],
        [2023, "黑龙江", "上海交通大学", "临床医学", "物理+化学+生物", 658],
        [2024, "黑龙江", "上海交通大学", "临床医学", "物理+化学+生物", 666],
        [2025, "黑龙江", "上海交通大学", "临床医学", "物理+化学+生物", 672],
        [2023, "黑龙江", "中国人民大学", "法学", "历史+政治", 647],
        [2024, "黑龙江", "中国人民大学", "法学", "历史+政治", 655],
        [2025, "黑龙江", "中国人民大学", "法学", "历史+政治", 661],
        [2023, "黑龙江", "华中科技大学", "电子信息工程", "物理+化学", 634],
        [2024, "黑龙江", "华中科技大学", "电子信息工程", "物理+化学", 642],
